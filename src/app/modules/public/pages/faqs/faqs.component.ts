...
export default class FaqsComponent implements OnInit {
  ...
  private setMetaTags(): void {
    ...
    this.title.setTitle('Preguntas Frecuentes - Compito.pe | FAQ | Dudas sobre Monitoreo de Precios');

    // Meta tags para SEO básicos
    this.meta.addTags([
      { name: 'description', content: 'Resuelve todas tus dudas sobre Compito.pe. Preguntas frecuentes sobre registro, funcionamiento, notificaciones WhatsApp y compatibilidad con tiendas peruanas como Falabella, MercadoLibre, Plaza Vea.' },
      { name: 'keywords', content: 'preguntas frecuentes compito, faq compito, dudas compito, como funciona compito, registro whatsapp, monitoreo precios peru, tiendas compatibles, falabella mercadolibre plazavea' },
      { name: 'author', content: 'Compito' },
      { name: 'robots', content: 'index, follow' },

      // Canonical URL para evitar contenido duplicado
      { name: 'canonical', content: 'https://compito.pe/faqs' },

      // Open Graph Meta Tags para compartir en redes sociales
      { property: 'og:title', content: 'Preguntas Frecuentes - Compito.pe | Todo sobre Monitoreo de Precios' },
      { property: 'og:description', content: '¿Dudas sobre cómo funciona Compito.pe? Encuentra respuestas sobre registro con WhatsApp, tiendas compatibles, notificaciones y más en nuestras FAQ.' },
      { property: 'og:image', content: 'https://compito.pe/assets/images/faq-help.jpg' },
      { property: 'og:url', content: 'https://compito.pe/faqs' },
      ...
      { name: 'twitter:title', content: 'FAQ Compito.pe | Preguntas Frecuentes sobre Monitoreo de Precios' },
      { name: 'twitter:description', content: 'Resuelve tus dudas sobre Compito.pe: registro WhatsApp, tiendas compatibles, notificaciones y más.' },
      { name: 'twitter:image', content: 'https://compito.pe/assets/images/faq-help.jpg' },
